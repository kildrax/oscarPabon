...
add_action('wp_enqueue_scripts', 'oscar_pabon_styles');

/**
 * Register and Enqueue Scripts.
 */
function oscar_pabon_scripts()
{
...
add_action('wp_enqueue_scripts', 'oscar_pabon_scripts');
